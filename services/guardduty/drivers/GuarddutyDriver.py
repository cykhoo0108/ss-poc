...
class GuardDutyDetail(Evaluator):
    ...
    def __check_findings(self):
            ...
            try:
                ...
                if finding_ids:
                    ...
                    for finding in findings.get('Findings', []):
                        ...
                        arr[finding['Severity']][type_].append({
                            'Id': finding['Id'],
        ...
        for serv, obj in arr.items():
            for type_, det in obj.items():
                arr[serv][type_]['__'] = self.__build_doc_links(type_)

        self.results['Findings'] = [-1, arr]

    def __check_usage_statistics(self):
        next_token = None
        try:
    ...
    def __check_free_trial_remaining(self):
        try:
    ...
    def __check_guard_duty_settings(self):
        try:
    ...
    def __build_doc_links(self, topic):
